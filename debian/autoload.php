...
require_once '/usr/share/php/Symfony/Polyfill/Intl/Normalizer/bootstrap.php';

spl_autoload_register(function (string $class): void {
    $prefix = 'Symfony\\Polyfill\\Intl\\Normalizer\\';
    if (str_starts_with($class, $prefix)) {
        $file = '/usr/share/php/Symfony/Polyfill/Intl/Normalizer/' . str_replace('\\', '/', substr($class, strlen($prefix))) . '.php';
        if (file_exists($file)) {
            require $file;
        }
    }
